import 'dart:async';
import 'package:aplikasi1/Pendukung/search_note.dart';
import 'package:flutter/material.dart';
import 'package:flutter_staggered_grid_view/flutter_staggered_grid_view.dart';
import 'package:sqflite/sqflite.dart';
import 'package:aplikasi1/db/db.dart';
import 'package:aplikasi1/Pendukung/notes.dart';
import 'package:aplikasi1/Pendukung/constant.dart';
import 'package:aplikasi1/Pendukung/note_detail.dart';
  ...
  Widget build(BuildContext context) {
        ...
        leading: noteList.length == 0
            ...
            : IconButton(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    navigateToDetail(result, 'Ubah Note');
                  }
                },
              ),
        actions: <Widget>[
    ...
    return Scaffold(
          ...
          ? Container(
              ...
              child: Center(
                child: Padding(
                  ...
                  child: Text('Klik disini untuk tambah nite',
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          navigateToDetail(Note('', '', 3, 0), 'Tambahkan Note');
        },
        tooltip: 'Tambahkan Note',
  ...
  Widget getNotesList() {
    return StaggeredGridView.countBuilder(
      ...
      itemBuilder: (BuildContext context, int index) => GestureDetector(
        onTap: () {
          navigateToDetail(this.noteList[index], 'Ubah Note');
        },
        child: Padding(
